     ...
     <div class="col-sm-12">
         <div class="panel panel-bd lobidrag">
             ...
             <div class="panel-body">
                 ...
                 <div class="form-group row">
                     <label for="unit_display_name" class="col-sm-2 text-right col-form-label">Print Name
                         :</label>
                     <div class="col-sm-4">

                         <input type="text" name="unit_display_name" class="form-control" id="unit_display_name"
                             placeholder="Print Name" value="<?php echo $unit->unit_display_name?>">
                     </div>
                 </div>
