		...
		<div class="panel panel-bd lobidrag">
			<div class="panel-heading" id="style12">
				<div class="panel-title">
					<span id="title"><?php echo display('manage_purchase_order') ?></span>
...
<script>
	...
	function getInvoiceData(fdate, tdate) {
		...
		$('#stockdisposalnote').DataTable({
			...
			'serverMethod': 'post',
			'ajax': {
				'url': base_url + 'purchase/purchase/checkpurchaseorder',
				data: {
					csrf_test_name: csrf_test_name,
					type2: type2,
	...
	function reprintInvoice(invoiceId) {
		if (confirm("Do you want to reprint this record")) {
			$.ajax({
				type: "post",
				url: $('#base_url').val() + 'purchase/purchase/pos_print2',
				data: {
					id: invoiceId,
