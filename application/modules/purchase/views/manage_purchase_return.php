		...
		<div class="panel panel-bd lobidrag">
			<div class="panel-heading" id="style12">
				<div class="panel-title">
					<span id="title"><?php echo display('manage_purchase_return') ?></span>
					<span class="padding-lefttitle">
						<table>
							<tr>
								...
								<td style="padding-left: 20px;">
									<?php if ($this->permission1->method('manage_purchase_return', 'create')->access()) { ?>
										<a href="<?php echo base_url('new_purchase_return') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('new_purchase_return') ?> </a>
									<?php } ?>
								</td>
							</tr>
						</table>
	...
	function getInvoiceData(fdate, tdate) {
	    ...
	    "use strict";
				...
				$('#stockdisposalnote').DataTable({
					...
					'serverMethod': 'post',
					'ajax': {
						'url': base_url + 'purchase/purchase/checkpurchasereturn',
						data: {
							csrf_test_name: csrf_test_name,
					type2: type2,
